...
import tools.chmap.psi_hdf as psihdf
...
from tools.chmap.coord_manip import interp_los_image_to_map, image_grid_to_CR, interp_los_image_to_map_yang, \
    ...
    def write_to_file(self, base_path, map_type=None, filename=None, db_session=None, AFT=False):
        ...
        if db_session is None:
            ...
            if AFT:
                ...
                crln_obs = self.sunpy_meta['cr_lon']
                crlt_obs = self.sunpy_meta['cr_lat']
